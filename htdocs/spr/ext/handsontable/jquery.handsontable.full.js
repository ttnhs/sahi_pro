...
Handsontable.Core = function (rootElement, userSettings) {
  ...
  datamap = {
    ...
    createRow: function (index, amount, createdAutomatically) {
      ...
      instance.PluginHooks.run('afterCreateRow', index, numberOfCreatedRows, createdAutomatically);
 ...
 *   * @param {Number} [amount] Optional.
    ...
    createCol: function (index, amount, createdAutomatically) {
      ...
      instance.PluginHooks.run('afterCreateCol', index, numberOfCreatedCols, createdAutomatically);
      instance.forceFullRender = true; //used when data was changed
    ...
    if (priv.settings.height === void 0) {
      if (priv.settingsFromDOM.overflow === 'scroll' || priv.settingsFromDOM.overflow === 'auto') {
        ...
        if (parent) {
          ...
          if (window.getComputedStyle(clone, null)) {
        	  computedHeight = parseInt(window.getComputedStyle(clone, null).getPropertyValue('height'), 10);
          }
