...
var _27d=$("<a href=\"#\"></a>").appendTo(_27c);
if(p.handler){
...
$("<a></a>").attr("href","#").text(_294).css("margin-left",10).bind("click",eval(_293[_294])).appendTo(tb).linkbutton();
}
}
...
//# to prevent call to onbeforeunload in IE.
...
//javascript:void(0) changed to # to prevent call to onbeforeunload in IE.
...
if(!t.length){
t=$("<a href=\"#\"></a>").addClass(_38a).appendTo(tool);
...
bc.append("<a href=\"#\" class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\"></a>");
}
}
tb.find(".textbox-button").remove();
if(opts.buttonText||opts.buttonIcon){
var btn=$("<a href=\"#\" class=\"textbox-button\"></a>").prependTo(tb);
...
_522.append("<a href=\"#\" class=\"spinner-arrow-up\"></a>");
_522.append("<a href=\"#\" class=\"spinner-arrow-down\"></a>");
...
var t=$("<a href=\"#\"></a>").html($.isFunction(btn.text)?btn.text(_96a):btn.text).appendTo(td);
...
(function($){
function init(_9ae){
var _9af=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"#\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_9ae);
var t=$(_9ae);
