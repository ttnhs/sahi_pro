	...
	<xsl:template match="suiteSummary">
		...
		<xsl:choose>
			<xsl:when test="$useDBURL = 'true'">
				<div id='navbar'> <a href='/_s_/dyn/pro/DBReports' style="color:black">Root</a> | <a href='/_s_/dyn/pro/DBReports_suiteReport?id={$suiteId}' style="color:black">Script Report</a> | <a href='/_s_/dyn/pro/DBReports_testCaseReport?id={$suiteId}' style="color:black">Test Cases Report</a> 
